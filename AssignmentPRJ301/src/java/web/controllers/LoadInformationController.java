...
public class LoadInformationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getSession().setAttribute("URL_HISTORY", "LoadInformationController");
            if (listCategory != null & listProduct != null) {
                url = SUCCESS;
            }
        } catch (Exception e) {
            log("Error at LoadInformationController: " + e.toString());
        } finally {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(LoadInformationController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
